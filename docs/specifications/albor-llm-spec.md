...
|----|-------|-----------|-----|----------|--------|---------------------|
| ALB-001 | [#6](https://github.com/paiml/albor/issues/6) | apr (aprender) | `apr tokenize plan/apply` subcommand | Medium | OPEN | `apr tokenize plan` validates inputs + estimates time; `apr tokenize apply` trains BPE tokenizer |
