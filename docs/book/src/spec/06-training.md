...
| 350M v3 (seq=1024, batch=4, codeparrot) | 5500/250K | 10.40→6.49 | ~1.7 days | **RUNNING** (PID 1975811): val_loss=7.13, val_ppl=1244 at step 5000. 6.6K tok/s, 19.0% MFU, 600ms/step. Checkpoints at 1K-5K (1520 MB each, verified). |
