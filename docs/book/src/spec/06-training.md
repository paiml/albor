...
| 350M v16 (from scratch, seed=456, canary-validated) | 155K target | 10.40→... | ~5.3 days | **RUNNING** — canary confirmed config is sane. seed=456. Launched March 25. Phase change expected step 3-5K. |
...
| 37000 | — | 632 | Spike. |
| 38000 | — | 540 | Elevated. |
| 39000 | — | 503 | Patience reset by resume — 7/30 (NOT 30/30). |
