...
| ~300 | Token co-occurrence and local patterns | v13 best-envelope (step 16K, 524M tokens) |
| ~130 | Sentence-level patterns and common idioms | v9 plateau (step 14K, 490M tokens); v13 projected ~step 28K |
